...
INSERT INTO messages VALUES("00000001","Yoshida Takeshi","aaaba");
INSERT INTO messages VALUES("00000002","Yoshida Yusaku","aaaba");
...
INSERT INTO patients (name,age,height,weight) VALUES ("Taro",44,175.6789,67.89345678);
...
INSERT INTO tmp_float VALUES(12345.56);
...
-- DECIMAL
ALTER TABLE patients ADD COLUMN score DECIMAL(7,3); -- 整数部が 4、小数部が 3
...
INSERT INTO tmp_decimal VALUES(1111111111.1111111111,1111111111.1111111111,91111111111.1111111111);
INSERT INTO tmp_decimal VALUES(1111111111.1111111111,1111111111.1111111111,1111111111.11111111112);
SELECT * FROM tmp_decimal;
...
SELECT HOUR(alarm_time),alarm_time FROM alerms;
SELECT MINUTE(alarm_time),alarm_time FROM alerms;
SELECT MONTH(alarm_day),alarm_time FROM alerms;
SELECT DAY(alarm_day),alarm_time FROM alerms;
SELECT DATE_FORMAT(alarm_day,"%d"),alarm_time FROM alerms;
